...
document.addEventListener("DOMContentLoaded", function () {
  ...
  formImage1.addEventListener("change", () => {
    uploadFile(formImage1.files[0], formPreview1);
  });
  formImage2.addEventListener("change", () => {
    uploadFile(formImage2.files[0], formPreview2);
  });
  formImage3.addEventListener("change", () => {
    uploadFile(formImage3.files[0], formPreview3);
  });
  formImage4.addEventListener("change", () => {
    uploadFile(formImage4.files[0], formPreview4);
  });
